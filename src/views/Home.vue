<template>
  <div class="home">
        <!-- Masthead-->
        <header class="masthead bg-whitee text-color text-center">
            <div class="container d-flex align-items-center flex-column">
                <!-- Masthead Avatar Image-->
                <img class="background-party mb-5" src="@/assets/party-bg.jpg" alt="..." />
...
export default {
  ...
  methods:{
        ...
        connectToParty(name, desc, email, location, img){
          ...
          console.log("Data from button: ",store.matchedPartyData)
